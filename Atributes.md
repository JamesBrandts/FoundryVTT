Here is a list of all dnd5e actor attributes. A Fighter character is used in this example.
This list comes courtesy of the excellent Actor Attribute Lists macro by @relick
Markdown file
For future use: foundry_dnd5e_properties.md
Abilities
